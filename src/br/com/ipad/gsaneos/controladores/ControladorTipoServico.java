...
public class ControladorTipoServico  extends ControladorBasico implements IControladorTipoServico{
	
	private static ControladorTipoServico instance;
	...
	protected ControladorTipoServico(){
		super();
	}
	
	public static ControladorTipoServico getInstance(){
		if ( instance == null ){
			instance =  new ControladorTipoServico();
